		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comsapktdemodemoday1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapktdemodemoday1-display": {
								"semanticObject": "comsapktdemodemoday1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.kt.demo.demoday1",
									"url": sap.ui.require.toUrl("com/sap/kt/demo/demoday1")
								}
							}
						}
					}
